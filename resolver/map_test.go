...
func (s) TestAddressMap_Values(t *testing.T) {
	...
	sort.Ints(got) // no need for this
...
func (s) TestEndpointMap_Length(t *testing.T) {
	...
	// Should it take into account number of the same address? I think so just
	// for defensiveness.
...
func (s) TestEndpointMap_Delete(t *testing.T) {
	...
	// should be 1 3 (how to assert? maybe on keys intertwining operations)
	// or
	// present:
