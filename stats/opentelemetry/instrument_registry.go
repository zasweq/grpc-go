...
// Either do here or plumb through stats/internal...
import "log"
...
// where are these labels and optional labels etaen?
...
func RegisterIntHisto(name string, desc string, unit string, labels []string, optionalLabels []string, def bool) IntHistoHandle {
	...
	return IntHistoHandle{ // pointer or not? it's one int I don't think it matters...
		index: len(intCountInsts) - 1,
	}
}
...
// I think this is really the correct place to read this..
