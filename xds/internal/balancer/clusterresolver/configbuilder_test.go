...
var (
	...
	addrCmpOpts = cmp.Options{
		...
		// cmpopts.IgnoreFields(resolver.Address{}, "Addr", "ServerName", "Attributes", "BalancerAttributes", "Type", "Metadata"),
	}
...
// Honestly I want to just delete this...come back to this on Monday
