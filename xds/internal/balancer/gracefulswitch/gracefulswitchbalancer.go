...
// 3. Clean up - including adding comments and passing VET, cleanup document as well

// 4. Send out Rough Draft PR - rebase this as a new file onto master

// 5. Learn testing and implement testing