...
// Call String() somehow on the child? defer it to the child recursively?

// the key type
// attributeKey{}: one value addr info {Weight} - in package weighted round robin

// attributeKey{}: one value addr info {LocalityWeight} - in package wrr_locality
